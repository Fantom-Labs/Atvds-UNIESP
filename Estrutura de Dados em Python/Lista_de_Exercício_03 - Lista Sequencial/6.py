'''
6. O hotel tem capacidade para 6 reservas. Insira os números de reserva: 101, 103, 107, 110, 115.
Depois, pesquise se a reserva 108 já foi cadastrada e mostre a resposta.
'''
...
reservas.inserir(101)
reservas.inserir(103)
reservas.inserir(107)
reservas.inserir(110)
reservas.inserir(115)

posicao = reservas.pesquisar(108)
if posicao != -1:
    print(f"Reserva 108 já cadastrada na posição {posicao}.")
else:
    print("Reserva 108 ainda não foi cadastrada.")
