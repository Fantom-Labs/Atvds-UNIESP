...
Pesquise se o aluno obteve a nota 75 e indique a posição encontrada.
'''
...
posicao = notas.pesquisar(75)
if posicao != -1:
    print(f"Nota 75 encontrada na posição {posicao}.")
else:
    print("Nota 75 não encontrada.")
